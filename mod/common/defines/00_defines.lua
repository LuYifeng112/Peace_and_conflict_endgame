...
NMilitary = {
	...
	PLAN_PORVINCE_PORT_BASE_IMPORTANCE = 30.0,		-- Added importance for area defense province with a port
...
NNavy = {
	...
	RESOURCE_ORIGIN_PRIORITY = 10,									-- Default convoy priority for resources shipped internally
...
NAI = {
	...
	PLAN_ATTACK_MIN_ORG_FACTOR_HIGH = 0.15,		
	...
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 15.0, 	-- How willing major powers are to send volunteers.
	SEND_VOLUNTEER_EVAL_CONTAINMENT_FACTOR = 30.0, -- How much AI containment factors into its evaluation of sending volunteers.
	...
	UPGRADE_PERCENTAGE_OF_FORCES = 0.5,					-- How big part of the army that should be considered for upgrading
