...
NDiplomacy = {
	...
	BASE_PEACE_PUPPET_FACTOR = 70,					-- Base factor for puppet in %.
	BASE_PEACE_LIBERATE_FACTOR = 40,				-- Base factor for liberate in %.
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 20.0, -- Base factor for taking state you do not control
	BASE_PEACE_TAKE_FACTION_CONTROLLED_STATE_FACTOR = 3, -- Base factor for taking state you do not control, but someone in faction does
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.05, 	-- Daily amount of popularity that will be added by the activity.
	BASE_STAGE_COUP_DAILY_PP = 0.8,					-- Daily pp cost for staging a coup
	...
	VERY_GOOD_OPINION = 40,							-- Threshold for a country that has a very good opinion of you.
	VERY_BAD_OPINION = -40,							-- Threshold for a country that has a very bad opinion of you.
	DIPLOMACY_HOURS_BETWEEN_REQUESTS = 24,			-- How long a country must wait before sending a new diplomatic request.
	TROOP_FEAR = 2, 								-- Impact on troops on borders when deciding how willing a nation is to trade
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.09,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.06,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
	VOLUNTEERS_RETURN_EQUIPMENT = 0.70,				-- Returning volunteers keep this much equipment
	...
	TENSION_FACTION_JOIN = 1,
	TENSION_JOIN_ATTACKER = 3,						-- scale of the amount of tension added when country joins attacker side
	TENSION_PEACE_FACTOR = 0.25,					-- scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = -5,							-- Amount of tension generated by liberating a country. 
	...
	BASE_CONDITIONAL_PEACE_MONTHS = 0.5,				-- War length must be before a surrender i possible.
	...
	MONTHLY_LEASED_IC_DECAY = 47,					-- How much of leased equipment is being "forgot" each month
	OPINION_PER_VOLUNTEER = 3,						-- Opinion bonus per one sent volunteer division
	MAX_OPINION_FROM_VOLUNTEERS = 40,				-- Opinion bonus per one sent volunteer division
	OPINION_FOR_DEMO_FROM_WT_GENERATION = -1.0,		-- How much less do democracies like us if we generate world tension
	NOT_READY_FOR_WAR_BASE = -100,					-- AI should be unwilling to enter accept a call to war if not ready for war against the relevant enemies.
	...
	RESOURCE_SENT_AUTONOMY_DAILY_BASE = 0.0000001,		-- If puppet provides resources to its master they increasy their autonomy by at least this amount
	...
	AUTONOMY_LEVEL_CHANGE_PP_COST_BASE = 200.0,		-- Base cost of changing level of autonomy
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 700,			-- Annexation cost
	...
	MASTER_BUILD_AUTONOMY_FACTOR = -1,            -- scales autonomy gain from construction by this
	...
	LICENSE_ACCEPTANCE_OPINION_FACTOR = 0.30,		-- Opinion modifier for acceptance of license production requests.
...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.0107,			-- basic population growth per year, used for monthly manpower gain
	...
	REINFORCEMENT_DELIVERY_SPEED_MIN = 0.9,			-- The distance from the supply region to capital should affect the speed only a little bit. Main factor for penalty is overcrowded areas, and not the route length.
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 0.3,	-- Modifier for army equipment reinforcement speed
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 3.0,	-- Modifier for army manpower reinforcement delivery speed (travel time)
	REINFORCEMENT_MANPOWER_CHUNK = 0.3,				-- Chunk size of manpower reinforcement delivery, in % of total manpower needed by the template.
	...
	NUCLEAR_PRODUCTION_SCALE = 120,					-- +1 nuclear_production gives 1 nuke per year
	...
	SUPPLY_CONVOY_FACTOR = 0.25,					-- How many convoys each supply needs
							                        -- how much range affects convoy need
	...
	BASE_STABILITY_WAR_FACTOR = -0.45,				-- Default stability war factor
	BASE_STABILITY_PARTY_POPULARITY_FACTOR = 0.3,	-- Default stability rulling party popularity factor
	...
	ARMY_IMPORTANCE_FACTOR = 10,					-- Army factor for AI and calculations
	TERRAIN_IMPORTANCE_FACTOR = 10.0,				-- Terrain base factor for state strategic value
	VICTORY_POINTS_IMPORTANCE_FACTOR = 5.0,			-- State victory points importance factor for AI and calculations
	BUILDING_IMPORTANCE_FACTOR = 8.0,				-- State building importance factor for AI and calculations
	RESOURCE_IMPORTANCE_FACTOR = 5.0,				-- State resource importance factor for AI and calculations
	...
	POLITICAL_POWER_CAP = 20000.0,					-- Max amount of political power country should have
	...
	CIVIL_WAR_INVOLVEMENT_MIN_TENSION = 0.00,		-- base value of world tension to involve other sides to the civil war
	...
	INTERCEPTION_BOMBING_WAR_SUPPORT_IMPACT = 0.5,	-- Max impact of interceptions on the war support

	BOMBING_WAR_SUPPORT_PENALTY_SCALE = -0.0015, 			-- Scaling of bomber damage to war support impact, will be added weekly as a war support penalty
	...
	AIR_VOLUNTEER_PLANES_LIMIT = 0.1,				-- Ratio for volunteer planes available for sending in relation to sender air force
	...
	DAYS_OF_WAR_BEFORE_SURRENDER = 0,				-- Number of days a war has to have existed before anyone can surrender in it
	...
	COUNTRY_MANPOWER_CAPITULATED_FREE_POOL_FACTOR = 0.3,	-- Factor on amount of normal manpower left for an exiled nation with no territory.
	...
	GIE_HOST_DOCKYARDS_FROM_LEGITIMACY_MAX = 1,				--Host will receive from 0 to this value in dockyards.
...
NProduction = {
	MAX_EQUIPMENT_RESOURCES_NEED = 8, 	-- Max number of different strategic resources an equipment can be dependent on.
	...
	BASE_FACTORY_START_EFFICIENCY_FACTOR = 40,	-- Base start efficiency for factories expressed in %.
	...
	ANNEX_FIELD_EQUIPMENT_RATIO = 0.75,	-- How much equipment from deployed divisions will be transferred on annexation
	...
	MIN_LICENSE_ACTIVE_DAYS = 15,						-- Min days for license to be active
...
NPolitics = {
	BASE_LEADER_TRAITS = 5,				-- Base amount of leader traits.
...
NMilitary = {
	...
	INFRA_ORG_IMPACT = 0.9,				-- scale factor of infra on org regain.
	...
	DIVISION_SIZE_FOR_XP = 3,                   -- how many battalions should a division have to count as a full divisions when calculating XP stuff
	...
	MAX_DIVISION_SUPPORT_HEIGHT = 5,		-- Max height of support in division designer.
										 	...
										 	--Base cost to unlock a regiment slot,
											--Base cost to change a regiment column.
										 	--Base cost to unlock a support slot
	
	MAX_ARMY_EXPERIENCE = 2000,			--Max army experience a country can store
	MAX_NAVY_EXPERIENCE = 2000,			--Max navy experience a country can store
	MAX_AIR_EXPERIENCE = 2000,				--Max air experience a country can store
	...
	ATTRITION_EQUIPMENT_LOSS_CHANCE = 0.25,		   -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
	ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.25, -- Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
	...
	RIVER_CROSSING_PENALTY = -0.1,                 -- small river crossing
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.1,			-- Balancing value to determine the chance of ground AA hitting an attacking airplane, affecting both the effective average damage done by AA to airplanes, and the reduction of damage done by airplanes due to AA support
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.05,				-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.

	ENCIRCLED_PENALTY = -0.8,                      -- penalty when completely encircled
	...
	SUPPLY_USE_FACTOR_INACTIVE = 0.95,
												   -- troops always carry 3 days of food and supply
	...
	PLAN_CONSIDERED_BAD = -0.25,					-- Plan evaluations below this value are considered unsafe
													-- The battle plan system will only automatically attack provinces in pockets that has no resistance and are no bigger than these many provinces
	...
	PLAN_SHARED_FRONT_PROV_IMPORTANCE_FACTOR = 0.8,	-- If fornt orders share end provinces, they should each have a somewhat reduced prio due to it being shared.
													...
													-- Added importance for area defense province with a port
													-- Bonus factor for port level
	PLAN_PORVINCE_AIRFIELD_BASE_IMPORTANCE = 10.0,	-- Added importance for area defense province with air field
	PLAN_PORVINCE_AIRFIELD_POPULATED_FACTOR = 15.5,	-- Bonus factor when an airfield has planes on it
	PLAN_PORVINCE_AIRFIELD_LEVEL_FACTOR = 0.25,		-- Bonus factor for airfield level
												    -- Used when calculating the calue of defense area provinces for the battle plan system (factored by resistance level)
	...
	PLAN_AREA_DEFENSE_FORT_IMPORTANCE = 0.25,		-- Used when calculating the calue of defense area provinces for the battle plan system, works as multipliers on the rest
													-- Used when calculating the calue of defense area provinces for the battle plan system
	...
	PLAN_EXECUTE_BALANCED_LIMIT = 0,				-- When looking for an attach target, this score limit is required in the battle plan to consider province for attack
													-- When looking for an attach target, this score limit is required in the battle plan to consider province for attack
	...
	PARADROP_HOURS = 16,							-- time paratroopers suffer penalties in combat
	...
	STRATEGIC_INFRA_SPEED = 10.0,                   -- Max of additional speed gained trouh=gh level for strategic redeployment per infra
													-- Ratio of max org while strategic redeployment
	...
	MIN_DIVISION_DEPLOYMENT_TRAINING = 0.0,			-- Min level of division training
	
													-- If a units path is at least this long to reach its front location, it will strategically redeploy.
	ARMY_INITIATIVE_REINFORCE_FACTOR = 0.25,		-- scales initiative for reinforce chance
	
	BASE_CAPTURE_EQUIPMENT_RATIO = 0.2,				-- after a successful land combat, ratio of the equipments that are being captured/salvaged from enemy's lost equipment
	...
	HOURS_REQ_REJOIN_BORDER_WAR_FOR_INJURED_UNITS = 3, -- minimum hours required for units to rejoin border wars
...
NNavy = {
	...
	SUPPLY_PRIORITY = 2,											-- Default convoy priority for supplying units via sea
																	-- Default convoy priority for export lend lease
	RESOURCE_EXPORT_PRIORITY = 4,									-- Default convoy priority for export trade
																	-- Default convoy priority for resources shipped internally
...
NAI = {
	GARRISON_FRACTION = 2.0, 					-- How large part of a front should always be holding the line rather than advancing at the enemy
	...
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 5.0,-- How much the AI takes global tension into account when considering faction actions
	...
	DIPLOMACY_SEND_ATTACHE_PP_FACTOR = 0.8,	-- Desire to send attache adds total PP multiplied by this
	...
	DIPLOMACY_SEND_MAX_FACTION = 0.4,			-- Country should not send away more units than this as expeditionaries
	DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 100,		-- Base value of volunteer acceptance (help is welcome)
	...
	RESEARCH_AHEAD_BONUS_FACTOR = 1.0,          -- To which extent AI should care about ahead of time bonuses to research
	RESEARCH_BONUS_FACTOR = 4.0, 				-- To which extent AI should care about bonuses to research
	MAX_AHEAD_RESEARCH_PENALTY = 2,             -- max ahead of tiem penalty ai will pick ever
	RESEARCH_AHEAD_OF_TIME_FACTOR = 15.0, 		-- To which extent AI should care about ahead of time penalties to research
	...
	DECLARE_WAR_RELATIVE_FORCE_FACTOR = 0.5,	-- Weight of relative force between nations that consider going to war
												-- Will at most trade away this fraction of factories.
	...
	DYNAMIC_STRATEGIES_THREAT_FACTOR = 15.0,		-- How much threat generated by other countries effects generated strategies
	...
	CALL_ALLY_BASE_DESIRE = 50,					-- exactly what it says
	CALL_ALLY_DEMOCRATIC_DESIRE = 70,			-- Desire to call ally added for democratic AI
	CALL_ALLY_NEUTRAL_DESIRE = 10,				-- Desire to call ally added for neutral AI
	CALL_ALLY_FASCIST_DESIRE = -10,				-- Desire to call ally added for fascist AI
	CALL_ALLY_COMMUNIST_DESIRE = 15,			-- Desire to call ally added for communist AI
	JOIN_ALLY_BASE_DESIRE = 10,					-- exactly what it says
	JOIN_ALLY_DEMOCRATIC_DESIRE = 30,			-- Desire to join ally added for democratic AI
	JOIN_ALLY_NEUTRAL_DESIRE = 5,				-- Desire to join ally added for neutral AI
	JOIN_ALLY_FASCIST_DESIRE = -10,				-- Desire to join ally added for fascist AI
	JOIN_ALLY_COMMUNIST_DESIRE = 10,			-- Desire to join ally added for communist AI
	...
	AT_WAR_THREAT_FACTOR = 25.0,					-- How much increase in threat does AI feel for being in war against osmeone
	NEIGHBOUR_WAR_THREAT_FACTOR = 10.10, 		-- How much increase in threat does AI feel against neighbours who are at war
	...
	POTENTIAL_FUTURE_ENEMY_FACTOR = 400, 		-- How much increase in threat does AI feel against neighbours who at war with our allies
	NEUTRAL_THREAT_PARANOIA = 75,				-- How scared neutrals are of everyone
	DIFFERENT_FACTION_THREAT = 10,				-- Threat caused by not being in the same faction
	...
	PLAN_FRONTUNIT_DISTANCE_FACTOR = 25.0,		-- Factor for candidate units distance to front positions.
	...
	IRRATIONALITY_LAMBDA = 10,					-- Lambda given to Poisson Random function determining if a leader should act a bit irrational 											
	...
	EASY_TARGET_FRONT_IMPORTANCE = 12.5,			-- How much extra focus the AI should put on who it considers to be the easiest target.
	...
	FRONT_TERRAIN_DEFENSE_FACTOR = 15.0,			-- Multiplier applied to unit defense modifier for terrain on front province multiplied by terrain importance
	FRONT_TERRAIN_ATTACK_FACTOR = 15.0,			-- Multiplier applied to unit attack modifier for terrain on enemy front province multiplied by terrain importance
	
	BASE_DISTANCE_TO_CARE = 10.0,				-- Countries that are too far away are less interesting in diplomacy
	...
	MAX_ALLOWED_NAVAL_DANGER = 40,				-- AI will ignore naval paths that has danger value of above this threshold while assigning units
	...
	NEEDED_NAVAL_FACTORIES_EXPENSIVE_SHIP_BONUS = 7,   -- Amount of naval yards you need to get a bonus to building really expensive ships
	...
	INVASION_COASTAL_PROVS_PER_ORDER = 12,				-- AI will consider one extra invasion per number of provinces stated here (num orders = total coast / this)
														...
														-- AI will try and keep 15% more convoys than what it needs.
														-- Threat value per convoy sunk in a region. Decays over time.
	...
	MAX_DISTANCE_NALAV_INVASION = 200.0,				-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
														-- If the enemy has a navy at least these many times stronger that the own, don't bother invading
	MIN_SUPPLY_USE_SANITY_CAP = 100,					-- Ignore supply cap if below this value when deciding on how many divisions to produce.
														-- To make sure the AI does not overdeploy divisions. Higher number means more supply per unit.
	...
	NAVAL_SHIP_AIR_IMPORTANCE = 5.0,					-- Naval ship air importance
	NAVAL_SHIP_IN_PORT_AIR_IMPORTANCE = 12.0,			-- Naval ship in the port air importance
	NAVAL_COMBAT_AIR_IMPORTANCE = 24.0,					-- Naval combat air importance
